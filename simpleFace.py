...
class SimpleFacerec:
    def __init__(self, frame_resizing=0.25, recognition_threshold=0.6): #0.25 and 0.6 tha
    ...
    def detect_known_faces(self, frame):
        ...
        for face_encoding in face_encodings:
            matches = face_recognition.compare_faces(self.known_face_encodings, face_encoding, tolerance=self.recognition_threshold)
            name = "Unknown"
...
class SimpleFacerec:
    def __init__(self, frame_resizing=0.25, recognition_threshold=0.5):
        self.known_face_encodings = []
        self.known_face_names = []
        self.frame_resizing = frame_resizing
        self.recognition_threshold = recognition_threshold
